$here = "$(Split-Path (Split-Path -Parent $MyInvocation.MyCommand.Path) -Parent)\LocalChocolateyPackage"

$module = 'LocalChocolateyPackage'
...
$pubFunctions = ('New-LocalChocolateyPackage','Install-LocalChocolateyPackage')
